...
function MeatMap({ mainColor = "#800000", strokeColor = "#c8c8c8", style }) {
    return (
        <svg 
            version="1.1" 
            id="svg46" 
            ...
            xmlnsXlink="http://www.w3.org/2000/svg" // xmlns:svg deve ser convertido para camelCase
            style={style} // Propriedade para estilizar externamente (width, margin, etc.)
        >
            <defs id="defs50" />
            <g 
                id="layer1"
                // Estilos CSS 'inline' convertidos para objeto style do React
                style={{
                    display: 'inline',
                    fill: mainColor, 
                    stroke: strokeColor, 
            ...
            >
                ...
                <path style={{fill:mainColor,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                ...
                <path style={{fill:mainColor,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    ...
                    id="path674" />
                <path
                    style={{fill:mainColor,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeDashoffset:0,strokeOpacity:1}}
                ...
                <path
                    style={{fill:mainColor,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeDashoffset:0,strokeOpacity:1}}
                    d="m 202.44692,45.981659 c 12.27061,7.502415 23.25245,17.369917 38.44584,19.508648 -3.22755,12.249145 -6.23892,25.038618 -10.49795,34.709643 -7.53494,0.6154 -15.48272,-2.062141 -23.3671,-4.233936 -10.15765,-31.588505 -5.75145,-32.617478 -4.58079,-49.984355 z"
                    id="path2100" />
                <path
                    style={{fill:mainColor,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'1.6, 0.4',strokeDashoffset:0,strokeOpacity:1}}
                    d="m 159.85717,50.319475 c 21.67924,2.735621 19.72099,5.593322 53.53747,5.407857 6.0377,2.007302 4.97361,12.51185 -0.8774,13.874656 -14.42184,-3.081562 -33.46285,-5.95806 -53.13776,-7.731302 v 0 c -3.43666,-1.537132 -5.39585,-9.73709 0.47769,-11.551211 z"
                    id="path1733" />
                <path
                    style={{fill:mainColor,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeDashoffset:0,strokeOpacity:1}}
                ...
                <path
                    style={{fill:mainColor,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeDashoffset:0,strokeOpacity:1}}
                    d="m 203.7952,38.267877 c 0.0882,-4.713013 40.84621,-4.469778 40.89713,0.825791 -1.02915,8.525572 -1.07286,17.051144 -3.5411,25.576716 -11.10994,-0.832583 -24.85021,-10.293101 -38.56284,-19.662953 0.28458,-2.368025 0.11076,-5.209297 1.20681,-6.739554 z"
                    id="path2098" />
                <path
                    style={{fill:mainColor,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeDashoffset:0,strokeOpacity:1}}
                ...
                <path
                    style={{fill:mainColor,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'1.6, 0.4',strokeDashoffset:0,strokeOpacity:1}}
                    d="m 213.90424,71.621644 c 12.87562,-7.403188 37.85656,8.51669 29.91177,22.233272 -11.93471,13.333114 -43.03419,-0.310637 -29.91177,-22.233272 z"
                    id="path2102" />
                <path
                    style={{fill:mainColor,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeDashoffset:0,strokeOpacity:1}}
                ...
                <text 
                    style={{fill:mainColor,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeDashoffset:0,strokeOpacity:1}}
                    x="106.81414" y="156.70776" id="text2170"
                >
                ...
                <text 
                    style={{
                        ...
                        fontWeight:'bold',
                        fontStretch:'normal',
                        fontSize:8, // Tamanhos sem unidade como 'px'
                        fontFamily:'monospace',
                        fill:'#ffebeb', // Cor dos números
                        fillOpacity:1,
                        stroke:strokeColor,
                        strokeWidth:0.4,
                        strokeDasharray:'none',
                    ...
                    x="107.15701" y="162.18944" id="text2228"
                >
                    <tspan id="tspan2226" x="107.15701" y="162.18944">1</tspan>
                </text>
                {/* ... (Os outros TEXTs seguem o mesmo padrão de conversão) ... */}

                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:8,fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="68.465927" y="116.40773" id="text2284">
                    <tspan id="tspan2282" x="68.465927" y="116.40773">2</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:8,fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="68.669029" y="71.520836" id="text2338">
                    <tspan id="tspan2336" x="68.669029" y="71.520836">3</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:8,fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="86.759506" y="56.2714" id="text2342">
                    <tspan id="tspan2340" x="86.759506" y="56.2714">4</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:8,fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="103.48561" y="30.305315" id="text2346">
                    <tspan id="tspan2344" x="103.48561" y="30.305315">5</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:8,fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="99.000626" y="118.07437" id="text2350">
                    <tspan id="tspan2348" x="99.000626" y="118.07437">6</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:8,fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="121.83655" y="55.65134" id="text2354">
                    <tspan id="tspan2352" x="121.83655" y="55.65134">7</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:8,fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="149.18015" y="58.885452" id="text2358">
                    <tspan id="tspan2356" x="149.18015" y="58.885452">8</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:8,fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="187.05403" y="50.895153" id="text2362">
                    <tspan id="tspan2360" x="187.05403" y="50.895153">9</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:8,fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="181.27515" y="62.121956" id="text2366">
                    <tspan id="tspan2364" x="181.27515" y="62.121956">10</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:8,fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="191.27379" y="84.807335" id="text2370">
                    <tspan id="tspan2368" x="191.27379" y="84.807335">11</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:'5.33333px',fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="203.00835" y="109.83437" id="text2374">
                    <tspan id="tspan2372" x="203.00835" y="109.83437">12</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:8,fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="148.28531" y="99.455818" id="text2378">
                    <tspan id="tspan2376" x="148.28531" y="99.455818">13</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:8,fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="219.34138" y="67.505371" id="text2382">
                    <tspan id="tspan2380" x="219.34138" y="67.505371">15</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:'6.66667px',fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="222.72125" y="88.031883" id="text2386">
                    <tspan id="tspan2384" x="222.72125" y="88.031883">16</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:8,fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="222.26607" y="50.595276" id="text2390">
                    <tspan id="tspan2388" x="222.26607" y="50.595276">14</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:'6.66667px',fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="215.90536" y="109.45922" id="text2394">
                    <tspan id="tspan2392" x="215.90536" y="109.45922">17</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:8,fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="228.60527" y="124.91893" id="text2398">
                    <tspan id="tspan2396" x="228.60527" y="124.91893">18</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:8,fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="242.57513" y="77.287758" id="text2402">
                    <tspan id="tspan2400" x="242.57513" y="77.287758">19</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:'6.66667px',fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="255.58685" y="88.037865" id="text2406">
                    <tspan id="tspan2404" x="255.58685" y="88.037865">20</tspan>
                </text>
                <text 
                    style={{fontStyle:'normal',fontWeight:'bold',fontStretch:'normal',fontSize:8,fontFamily:'monospace',fill:'#ffebeb',fillOpacity:1,stroke:strokeColor,strokeWidth:0.4,strokeDasharray:'none',strokeOpacity:1}}
                    x="237.50116" y="153.3748" id="text2410">
                    <tspan id="tspan2408" x="237.50116" y="153.3748">21</tspan>
                </text>
            </g>
        </svg>
    );
